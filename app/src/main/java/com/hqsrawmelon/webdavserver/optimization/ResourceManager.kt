...
object ResourceManager {
     ...
     * 注册 Activity
     */
    fun registerActivity(key: String, activity: Activity) {
    ...
    fun createScope(key: String): CoroutineScope {
        return coroutineScopes.getOrPut(key) {
     ...
     * 添加可清理的资源
     */
    fun addDisposable(key: String, disposable: () -> Unit) {
...
fun Activity.createManagedScope(): CoroutineScope {
    return ResourceManager.createScope(this::class.java.simpleName)
}
